...
const CSV_TEMPLATE = [
  'name,sku,barcode,price,salePrice,buyingPrice,dealerPrice,stock,status,featured,bundle,categorySlug,brandSlug,shortDesc,description,images,metaTitle,metaDesc,relatedSkus,accessorySkus,fittingSkus',
  '"Premium Basin Mixer",TMP-001,8901234567890,4500,3999,2800,3200,50,ACTIVE,false,false,bathroom-fittings,toto,"High-quality chrome basin mixer","Single-lever basin mixer with ceramic cartridge. Chrome finish.",https://example.com/img1.jpg|https://example.com/img2.jpg,"Premium Basin Mixer | Brand","Best basin mixer for your bathroom",,TMP-002,',
  '"Bottle Trap",TMP-002,,650,,420,550,100,ACTIVE,false,false,bathroom-accessories,,,"Bottle trap for basin waste connection","P-type bottle trap with adjustable height.",,,,,',
  '"Basin & Mixer Bundle",BDL-003,8909876543210,5000,4500,3100,3800,20,ACTIVE,true,true,bathroom-fittings,toto,"Basin and mixer combo bundle","Complete bundle including pedestal basin and single-lever mixer.",https://example.com/bundle.jpg,"Basin Mixer Bundle","Complete basin and mixer bundle",TMP-001,,'
].join('\n')
